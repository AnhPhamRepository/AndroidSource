...
public class MainActivity extends AppCompatActivity {
    ...
    protected void startProccess(View v) {
        countTimeProccess = new CountDownTimer(32000,1000) {
            @Override
            public void onTick(long millisUntilFinished) {
    ...
    public void dialogGameWin(View v) {
        ...
        dialogView.findViewById(R.id.nextbt).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                nextIntent = new Intent(MainActivity.this, stage2Activity.class);
                if (interstitialAd != null && interstitialAd.isAdLoaded()) {
                    interstitialAd.show();
                }else{
                    showNextScreen();
    ...
    public void playBackgroundSound() {
        Intent intentSoundBackground = new Intent(MainActivity.this, BackgroundSoundService.class);
        startService(intentSoundBackground);
    }
}